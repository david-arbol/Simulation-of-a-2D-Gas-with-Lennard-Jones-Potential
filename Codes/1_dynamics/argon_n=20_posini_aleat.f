      ! Dynamics and Temperature starting with 20 particles in random positions, ensuring that they are not too close to each other.
      program argon
      implicit none
      ...
      do i=1,n
           ...
           v(i,1)=1.d0*cos(ang_aux)
           v(i,2)=1.d0*sin(ang_aux)
      enddo
...
!!!!!!!Calculo aceleraci▋ siguiente
      ...
      write(5,*) t, Ec, Ep, Et
         ...
         !Temperatura
         if((t.ge.70.d0).and.(t.le.170.d0)) then
           cont=cont+1
           do i=1,n
      ...
      write(8,*) "Valor medio de temperatura entre t=70-170s", Temp
