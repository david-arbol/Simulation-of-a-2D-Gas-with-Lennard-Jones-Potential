      ...
      real*8 pdec
      real*8 paux(2)
      !Variables para cculos posteriores
      real*8 Ec,Ep,Et,Temp, perturb,pi
      integer cont
      ...
      r(1,1)=0.5d0+perturb*dcos(ang_aux)
      r(1,2)=0.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(2,1)=1.5d0+perturb*dcos(ang_aux)
      r(2,2)=0.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(3,1)=2.5d0+perturb*dcos(ang_aux)
      r(3,2)=0.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(4,1)=3.5d0+perturb*dcos(ang_aux)
      r(4,2)=0.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(5,1)=0.5d0+perturb*dcos(ang_aux)
      r(5,2)=1.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(6,1)=1.5d0+perturb*dcos(ang_aux)
      r(6,2)=1.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(7,1)=2.5d0+perturb*dcos(ang_aux)
      r(7,2)=1.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(8,1)=3.5d0+perturb*dcos(ang_aux)
      r(8,2)=1.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(9,1)=0.5d0+perturb*dcos(ang_aux)
      r(9,2)=2.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(10,1)=1.5d0+perturb*dcos(ang_aux)
      r(10,2)=2.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(11,1)=2.5d0+perturb*dcos(ang_aux)
      r(11,2)=2.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(12,1)=3.5d0+perturb*dcos(ang_aux)
      r(12,2)=2.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(13,1)=0.5d0+perturb*dcos(ang_aux)
      r(13,2)=3.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(14,1)=1.5d0+perturb*dcos(ang_aux)
      r(14,2)=3.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(15,1)=2.5d0+perturb*dcos(ang_aux)
      r(15,2)=3.5d0+perturb*dsin(ang_aux)
      ang_aux=dran_u()*4.d0*datan(1.d0)*2.d0
      r(16,1)=3.5d0+perturb*dcos(ang_aux)
      r(16,2)=3.5d0+perturb*dsin(ang_aux)

      write(2,*) ((r(i,j), j=1,2), i=1,n)
      write(2,*)
      write(2,*)

      !Inicializo las velocidades iniciales a modulo 0
